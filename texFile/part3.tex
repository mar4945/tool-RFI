...
\begin{figure}[h]
	\resizebox{\linewidth}{!}{\input{figure/Part3/levels.tex}}
...
In this work, we introduce a control system architecture
...
\begin{figure}[H]
	\resizebox{\linewidth}{!}{\input{figure/Part3/controlSystem.tex}}
...
\begin{subfigure}{\linewidth}
	...
	\begin{tikzpicture}[trim axis left, spy using outlines=
		...
		\begin{axis}[
			...
			\addlegendentry{$x_1^{\mathrm{L}}-x_1^{\mathrm{F}} ( 2\unit{\second} )$}
