...
\draw (345.17,143.14) node  {\includegraphics[width=451.25pt,height=87.97pt]{figure/ERTMS_Background2.png}};
...
\draw [color={rgb, 255:red, 245; green, 166; blue, 35 }  ,draw opacity=1 ][line width=1.5]    (76.67,95.58) -- (210,96) ;
...
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ][line width=1.5]  [dash pattern={on 5.63pt off 4.5pt}]  (397,74) -- (80,70) ;
...
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (199,152) -- (199.96,216) ;
\draw [shift={(200,219)}, rotate = 269.14] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
%Straight Lines [id:da09482912953606859] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (611,161) -- (611.95,214) ;
\draw [shift={(612,217)}, rotate = 268.98] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;

% Text Node
\draw (74,72) node [anchor=north west][inner sep=0.75pt]  [font=\normalsize]  {$v_{F}$};
% Text Node
\draw (188,217) node [anchor=north west][inner sep=0.75pt]  [font=\normalsize]  {$s_{F}$};
% Text Node
\draw (599.5,214) node [anchor=north west][inner sep=0.75pt]  [font=\normalsize]  {$s_{L}$};
% Text Node
\draw (415,143.5) node [anchor=north west][inner sep=0.75pt]  [font=\normalsize]  {$S_{L4}$};
% Text Node
\draw (73.33,38.67) node [anchor=north west][inner sep=0.75pt]  [font=\normalsize]  {$v_{L}$};
% Text Node
\draw (54,123.5) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 245; green, 166; blue, 35 }  ,opacity=1 ] [align=left] {Follower};
% Text Node
...
% Text Node
\draw (283.83,142) node [anchor=north west][inner sep=0.75pt]    {$d_{L3}( t)$};
% Text Node
\draw (361,75.5) node [anchor=north west][inner sep=0.75pt]   [align=left] {LoA};
% Text Node
\draw (229.67,23) node [anchor=north west][inner sep=0.75pt]    {$ \begin{array}{l}
\gamma _{L} 4( t)\\
\end{array}$};
% Text Node
\draw (625.67,219.33) node [anchor=north west][inner sep=0.75pt]    {$s$};
% Text Node
\draw (12,11.67) node [anchor=north west][inner sep=0.75pt]    {$v$};
% Text Node
\draw (363.33,33.67) node [anchor=north west][inner sep=0.75pt]  [font=\normalsize]  {$v_{L} =v_{F}$};
% Text Node
\draw (178.33,71.67) node [anchor=north west][inner sep=0.75pt]  [font=\normalsize]  {$T_{T}$};
% Text Node
\draw (401.58,74.09) node [anchor=north west][inner sep=0.75pt]  [font=\normalsize]  {$T_{T} +T_{D}$};
% Text Node
\draw (15.33,214.67) node [anchor=north west][inner sep=0.75pt]  [font=\normalsize]  {$0$};
