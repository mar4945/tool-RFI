...
def load_data(json_config):
    ...
    pos_leader_1 = data['train_parameters']['pos_leader_1']
    vel_leader_1 = data['train_parameters']['vel_leader_1']
    pos_leader_2 = data['train_parameters']['pos_leader_2']
    vel_leader_2 = data['train_parameters']['vel_leader_2']
    pos_follower_1 = data['train_parameters']['pos_follower_1']
    vel_follower_1 = data['train_parameters']['vel_follower_1']
    pos_follower_2 = data['train_parameters']['pos_follower_2']
    vel_follower_2 = data['train_parameters']['vel_follower_2']
    ...
    # here select the train's variables for the two operational scenarios
    if os1:
        pos_leader = pos_leader_1
...
def init_simulation():
    ...
    ato_follower = ATO(N_f, ts,ref_tau_1, ref_tau_2, ref_tau_3, os1)
    ato_leader = ATO(N_l, ato_leader_ts, None, None, None, False)
...
def run_simulation():
    ...
    for t in range(0, int(time_simulation/ts), 1):
        ...
        v_l_target = check_os1(os1, timestamp, v_l_target)
        
        check_os2(os2, timestamp, commNetwork)
...
def check_os1(os1, timestamp, v_l_target):
...
def check_os2(os2, timestamp, commNetwork):
    if os2 and  timestamp>500 :
        commNetwork.set_param_channel(3)
...
def save_txt_files():
    ...
    create_txt_from_lists(time_delay_list,delay_channel_list,N,"delay_channel_list.txt")
    create_txt_from_lists(time_delay_list,delay_channel_list,1,"delay_channel_list_all.txt")
